...
(4, 'T1C4', 'La suma de un numero, su doble y su triple es 42.', '../assets/img/T1A4.gif'),
(5, 'T1C5', 'La suma de tres numeros consecutivos es 61.', '../assets/img/T1A5.gif'),
...
(7, 'T1C7', 'Victoria tiene la mitad de la edad de Estefania menos 8 años, ¿Como se expresa la edad de Juan?', '../assets/img/T1A7.gif'),
(8, 'T1C8', 'Rafael gasto $350.00 en sodas y chocolates, si una soda cuesta $15.00 y un chocolate $20.00, ¿Como se expresa cuanto compro de cada uno?', '../assets/img/T1A8.gif'),
(9, 'T1C9', 'Evalua la siguiente funcion cuando n = -5 ../assets/img/T1Q9.gif', '../assets/img/T1A9.gif'),
(10, 'T1C10', 'Evalua la siguiente funcion cuando m = 3 ../assets/img/T1Q10.gif', '../assets/img/T1A10.gif'),
(11, 'T1C11', 'Evalua la siguiente funcion cuando a = 3 y b = 2 ../assets/img/T1Q11.gif', '../assets/img/T1A11.gif'),
(12, 'T2C1', 'Resuelve la siguiente operacion algebraica ../assets/img/T2Q1.gif', '../assets/img/T2A1.gif'),
(13, 'T2C2', 'Resuelve la siguiente operacion algebraica ../assets/img/T2Q2.gif', '../assets/img/T2A2.gif'),
(14, 'T2C3', 'Resuelve la siguiente operacion algebraica ../assets/img/T2Q3.gif', '../assets/img/T2A3.gif'),
(15, 'T2C4', 'Resuelve la siguiente operacion algebraica ../assets/img/T2Q4.gif', '../assets/img/T2A4.gif'),
(16, 'T2C5', 'El resultado de ../assets/img/T2Q5.gif', '../assets/img/T2A5.gif'),
(17, 'T2C6', 'Al simplificar la expresion ../assets/img/T2Q6.gif', '../assets/img/T2A6.gif'),
...
(20, 'T2C9', 'Al simplificar la expresion ../assets/img/T2Q9.gif', '../assets/img/T2A9.gif'),
...
(30, 'T2C19', 'Resuelve el siguiente binomio con termino comun ../assets/img/T2Q19.gif', '../assets/img/T2A19.gif'),
(31, 'T2C20', 'Resuelve el siguiente binomio con termino comun ../assets/img/T2Q20.gif', '../assets/img/T2A20.gif'),
(32, 'T2C21', 'Resuelve la siguiente factorizacion ../assets/img/T2Q21.gif', '../assets/img/T2A21.gif'),
(33, 'T2C22', 'Resuelve la siguiente factorizacion ../assets/img/T2Q22.gif', '../assets/img/T2A22.gif'),
(34, 'T2C23', 'Resuelve la siguiente factorizacion ../assets/img/T2Q23.gif', '../assets/img/T2A23.gif'),
(35, 'T2C24', 'Resuelve la siguiente factorizacion ../assets/img/T2Q24.gif', '../assets/img/T2A24.gif'),
(36, 'T3C1', 'Resuelve la siguiente ecuacion ../assets/img/T3Q1.gif', '../assets/img/T3A1.gif'),
(37, 'T3C2', 'Resuelve la siguiente ecuacion ../assets/img/T3Q2.gif', '../assets/img/T3A2.gif'),
(38, 'T3C3', 'Resuelve la siguiente ecuacion ../assets/img/T3Q3.gif', '../assets/img/T3A3.gif'),
(39, 'T3C4', 'Resuelve la siguiente ecuacion ../assets/img/T3Q4.gif', '../assets/img/T3A4.gif'),
(40, 'T3C5', 'Resuelve la siguiente ecuacion ../assets/img/T3Q5.gif', '../assets/img/T3A5.gif'),
(41, 'T3C6', 'Utiliza el metodo de reduccion para el siguiente sistema: ../assets/img/T3Q6.png', '../assets/img/T3A6.gif'),
(42, 'T3C7', 'Utiliza el metodo de sustitucion para el siguiente sistema: ../assets/img/T3Q7.png', '../assets/img/T3A7.gif'),
(43, 'T3C8', 'Utiliza el metodo de igualacion para el siguiente sistema: ../assets/img/T3Q8.png', '../assets/img/T3A8.gif'),
(44, 'T3C9', 'Resuelve el siguiente sistema: ../assets/img/T3Q9.png', '../assets/img/T3A9.gif'),
(45, 'T3C10', 'Hallar un numero de dos cifras sabiendo que la suma de las cifras es 12 y que la primera de ellas es el triple de la segunda. ../assets/img/T3Q10.png', '../assets/img/T3A10.gif');
