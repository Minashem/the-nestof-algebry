...
(9, 'T1C9', 'Evalúa la siguiente función cuando n = -5 ../assets/img/T1Q9.gif', '../assets/img/T1A9.gif'),
(10, 'T1C10', 'Evalúa la siguiente función cuando m = 3 ../assets/img/T1Q10.gif', '../assets/img/T1A10.gif'),
(11, 'T1C11', 'Evalúa la siguiente función cuando a = 3 y b = 2 ../assets/img/T1Q11.gif', '../assets/img/T1A11.gif'),
...
(36, 'T3C1', 'Resuelve la siguiente ecuación ../assets/img/T3Q1.gif', '../assets/img/T3A1.gif'),
(37, 'T3C2', 'Resuelve la siguiente ecuación ../assets/img/T3Q2.gif', '../assets/img/T3A2.gif'),
(38, 'T3C3', 'Resuelve la siguiente ecuación ../assets/img/T3Q3.gif', '../assets/img/T3A3.gif'),
(39, 'T3C4', 'Resuelve la siguiente ecuación ../assets/img/T3Q4.gif', '../assets/img/T3A4.gif'),
(40, 'T3C5', 'Resuelve la siguiente ecuación ../assets/img/T3Q5.gif', '../assets/img/T3A5.gif'),
(41, 'T3C6', 'Utiliza el método de reducción para el siguiente sistema: ../assets/img/T3Q6.png', '../assets/img/T3A6.gif'),
(42, 'T3C7', 'Utiliza el método de sustitución para el siguiente sistema: ../assets/img/T3Q7.png', '../assets/img/T3A7.gif'),
(43, 'T3C8', 'Utiliza el método de igualación para el siguiente sistema: ../assets/img/T3Q8.png', '../assets/img/T3A8.gif'),
(44, 'T3C9', 'Resuelve el siguiente sistema: ../assets/img/T3Q9.png', '../assets/img/T3A9.gif'),
(45, 'T3C10', 'Hallar un número de dos cifras sabiendo que la suma de las cifras es 12 y que la primera de ellas es el triple de la segunda. ../assets/img/T3Q10.png', '../assets/img/T3A10.gif');
